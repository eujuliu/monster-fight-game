...
function MonsterCard({ monster, ...rest }: Props) {
  return (
    <div
      {...rest}
      className={cn(
        "w-full min-h-[400px] max-w-[350px] max-h-[450px] rounded-xl bg-[url(/images/backgrounds/guillaume-lucbert-sewers.jpg)] bg-cover bg-center",
        rest.className,
      )}
    >
      <div
      ...
      >
        ...
        <div className="relative bg-black/70 p-4 rounded-lg mt-auto w-full">
